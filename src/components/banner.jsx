...
const Banner = () => {
  ...
  // bg-neutral-950 bg-opacity-70  md:bg-opacity-70
  ...
  return (
    <>
      ...
      <div className="absolute z-10 inset-0  bg-gray-950 bg-opacity-70  md:bg-opacity-70"
        style={{
      ...
      <div className="container_title_b relative z-20 text-start md:text-center  w-5/6 md:w-full xl:w-screen flex flex-col md:items-center  ">
        ...
        <motion.h1
          ...
          className="description_banner mt-6 text-xl text-stone-50">Desarrollo y diseño de paginas WEB</motion.h1>
        <Link href='#contacto'>
