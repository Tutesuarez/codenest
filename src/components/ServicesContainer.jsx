...
const ServicesContainer=()=>{
    return(
        <div className="serv_container flex flex-col justify-items-center">
            <div className=" text-center mx-auto mt-5 justify-items-center  text-stone-50">
              <div className="serv_title mb-8 mt-10 max-w-fit">
                <p className=" text-teal-400  font-bold">SERVICIOS</p>
              </div>
              <RevealTextSegundo>
              <h2 className="serv_principal_title px-2 text-4xl font-heading font-bold">
