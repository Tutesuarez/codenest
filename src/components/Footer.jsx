...
const Footer = () => {
    return (
        <footer className="bg-gray-900 text-white text-center p-6 border-t-2 border-t-stone-50 border-opacity-10 ">
            <div className="flex flex-col md:grid md:grid-cols-2 mx-16  md:py-3">
